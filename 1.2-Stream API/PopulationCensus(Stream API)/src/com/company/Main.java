...
//        System.out.println(count);
        ...
        List<String> familiesRecruit =  persons.stream()
                .filter(x -> x.getAge() >= 18 && x.getAge() < 27)
                .filter(x -> x.getSex() != Sex.WOMAN)
                .map(Person::getFamily)
                .collect(Collectors.toList());
//        System.out.println(familiesRecruit);

        List<String> familiesHighEducation = persons.stream()
                ...
                .map(Person::getFamily)
                .collect(Collectors.toList());
//        System.out.println(familiesHighEducation);
